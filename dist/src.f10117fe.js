...
function () {
  function View(parent, model) {
    ...
    this.regions = {};
    this.bindModel();
  } // default eventsMap implementation


  View.prototype.eventsMap = function () {
    return {};
  }; // default regionsmap implememtation
...
function (_super) {
  ...
  User.buildUserCollections = function () {
    return new Collections_1.Collections(RootUrl, function (json) {
...
var users = new Collections_1.Collections('http://localhost:3000/users', function (json) {
...
users.fetch(); // import { UserEdit } from './view/UserEdit';
...
// }
},{"./view/UserList":"src/view/UserList.ts","./models/Collections":"src/models/Collections.ts","./models/User":"src/models/User.ts"}],"../../../../AppData/Roaming/nvm/v10.17.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
